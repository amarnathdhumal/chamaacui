        ...
        props={[
          {
            ...
            default: "-",
            description:
              "Array of trend objects. Each trend should have id (string), name (string), and icon (Icon component from @tabler/icons-react)",
            required: true,
          },
          {
            name: "imageSrc",
            ...
            default: '"/gpt.jpg"',
            description:
              "Source path for the profile image displayed on the right side",
            required: false,
          },
          {
            name: "imageAlt",
          ...
          },
          {
            ...
            default: "0.1",
            description:
              "Delay in seconds between each trend item animation. Items animate with staggered delays (index * delay)",
            required: false,
          },
        ]}
      />
