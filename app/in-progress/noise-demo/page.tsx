  ...
  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div className="bg-black/30 p-4 rounded-lg">
                <h4 className="font-semibold text-white mb-2">baseFrequency</h4>
              ...
              <div className="bg-black/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-400">
                  Controls intensity. 0.2-0.3 for subtle, 0.4-0.5 for noticeable
                  effect.
                </p>
              </div>
              <div className="bg-black/30 p-4 rounded-lg">
                <h4 className="font-semibold text-white mb-2">stitchTiles</h4>.
                <p className="text-sm text-gray-400">
