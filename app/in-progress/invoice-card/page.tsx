      ...
      <InvoiceCardPreviewWrapper
        ...
        props={[
          ...
          },
          {
            ...
            default: "-",
            description:
              "The total amount to be displayed prominently at the top of the invoice",
            required: true,
          },
          {
            name: "originalAmount",
            ...
            default: "-",
            description:
              "Optional original amount to show a crossed-out price (for discounts)",
            required: false,
          },
          {
            name: "items",
            ...
            default: "-",
            description:
              "Array of invoice items. Each item should have name (string), description (string), and price (number)",
            required: true,
          },
          {
            name: "taxRate",
            ...
            default: "0",
            description:
              "Tax rate as a percentage (e.g., 10 for 10%). If 0, tax line will not be displayed",
            required: false,
          },
          {
            name: "taxLabel",
          ...
          },
          {
            ...
            default: "0.1",
            description:
              "Delay in seconds between each animation. Line items animate with staggered delays (index * delay), summary items appear after all line items",
            required: false,
          },
          {
            name: "className",
