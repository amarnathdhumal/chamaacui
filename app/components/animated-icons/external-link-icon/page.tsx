...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/external-link-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/external-link-icon/external-link-icon-demo.tsx");
