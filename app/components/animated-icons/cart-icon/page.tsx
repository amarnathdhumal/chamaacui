...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/cart-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/cart-icon/cart-icon-demo.tsx");
