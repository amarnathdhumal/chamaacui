...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/arrow-down-right-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/arrow-down-right-icon/arrow-down-right-icon-demo.tsx");
