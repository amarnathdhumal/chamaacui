...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/refresh-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/refresh-icon/refresh-icon-demo.tsx");
