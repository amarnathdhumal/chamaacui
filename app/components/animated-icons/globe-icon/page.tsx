...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/globe-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/globe-icon/globe-icon-demo.tsx");
        ...
        <div className="flex flex-col w-full">
            <GlobeIconPreviewWrapper
                ...
                props={[
                    ...
                    { name: "duration", type: "number", default: "8", description: "Duration of the animation in seconds", required: false },
