...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/arrow-right-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/arrow-right-icon/arrow-right-icon-demo.tsx");
