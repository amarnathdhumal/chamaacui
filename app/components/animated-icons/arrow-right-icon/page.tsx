...
const filePath = path.join(
  process.cwd(),
  "registry/chamaac/animated-icons/arrow-right-icon.tsx"
);
const demoFilePath = path.join(
  process.cwd(),
  "app/components/animated-icons/arrow-right-icon/arrow-right-icon-demo.tsx"
);
  ...
  return (
    <div className="flex flex-col w-full">
      <ArrowRightIconPreviewWrapper
        ...
        description="An animated arrow right icon that moves horizontally."
        code={DemoSource}
        codeFilename="arrow-right-icon-demo.tsx"
