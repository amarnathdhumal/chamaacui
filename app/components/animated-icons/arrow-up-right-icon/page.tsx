...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/arrow-up-right-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/arrow-up-right-icon/arrow-up-right-icon-demo.tsx");
const ComponentSource = fs.readFileSync(filePath, "utf-8");
const DemoSource = fs.readFileSync(demoFilePath, "utf-8");

export const metadata = constructMetadata({
    title: "Arrow Up Right Icon",
    description: "An animated diagonal arrow icon.",
