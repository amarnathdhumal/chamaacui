...
const filePath = path.join(
  process.cwd(),
  "registry/chamaac/animated-icons/location-icon.tsx"
);
const demoFilePath = path.join(
  process.cwd(),
  "app/components/animated-icons/location-icon/location-icon-demo.tsx"
);
  ...
  return (
    <div className="flex flex-col w-full">
      <LocationIconPreviewWrapper
        ...
        description="An animated location pin icon with a bounce drop effect."
        code={DemoSource}
        codeFilename="location-icon-demo.tsx"
