...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/activity-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/activity-icon/activity-icon-demo.tsx");
