import SparkleIconPreviewWrapper from "./sparkle-icon-preview-wrapper";
import fs from "fs";
...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/sparkle-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/sparkle-icon/sparkle-icon-demo.tsx");
...
export default function SparkleIconPage() {
    return (
        <div className="flex flex-col w-full">
            <SparkleIconPreviewWrapper
                title="Sparkle Icon"
                description="An animated sparkle icon with twinkling stars."
                code={
