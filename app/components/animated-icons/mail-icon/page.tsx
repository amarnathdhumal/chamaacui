...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/mail-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/mail-icon/mail-icon-demo.tsx");
        ...
        <div className="flex flex-col w-full">
            <MailIconPreviewWrapper
                ...
                props={[
                    ...
                    { name: "duration", type: "number", default: "4", description: "Duration of the animation in seconds", required: false },
