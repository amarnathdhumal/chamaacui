...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/arrow-down-left-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/arrow-down-left-icon/arrow-down-left-icon-demo.tsx");
