...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/arrow-left-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/arrow-left-icon/arrow-left-icon-demo.tsx");
