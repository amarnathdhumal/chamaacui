import ChevronsUpIconPreviewWrapper from "./chevrons-up-icon-preview-wrapper";
import fs from "fs";
...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/chevrons-up-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/chevrons-up-icon/chevrons-up-icon-demo.tsx");
const ComponentSource = fs.readFileSync(filePath, "utf-8");
const DemoSource = fs.readFileSync(demoFilePath, "utf-8");

export const metadata = constructMetadata({
    title: "Chevrons Up Icon",
    description: "Animated double chevrons pointing up.",
    image: "/components/animated-icons.png",
});

export default function ChevronsUpIconPage() {
    return (
        <div className="flex flex-col w-full">
            <ChevronsUpIconPreviewWrapper
                title="Chevrons Up Icon"
                description="Animated double chevrons pointing up."
                code={
