    ...
    return (
        ...
        >
            ...
            <motion.path
                ...
                transition={{ duration: 2, repeat: Infinity, ease: "easeInOut", repeatType: "reverse", delay: 0.1 }}
            />
            <motion.path
                d="M8 11a4 4 0 0 1 8 0v1a10 10 0 0 0 2 6"
                initial={{ pathLength: 0, opacity: 0.5 }}
                animate={{ pathLength: 1, opacity: 1 }}
                transition={{ duration: 2.2, repeat: Infinity, ease: "easeInOut", repeatType: "reverse", delay: 0.3 }}
            />
            <motion.path
                d="M12 11v2a14 14 0 0 0 2.5 8"
                initial={{ pathLength: 0, opacity: 0.5 }}
                animate={{ pathLength: 1, opacity: 1 }}
                transition={{ duration: 1.8, repeat: Infinity, ease: "easeInOut", repeatType: "reverse", delay: 0.2 }}
            />
            <motion.path
                d="M8 15a18 18 0 0 0 1.8 6"
                initial={{ pathLength: 0, opacity: 0.5 }}
                animate={{ pathLength: 1, opacity: 1 }}
                transition={{ duration: 2, repeat: Infinity, ease: "easeInOut", repeatType: "reverse", delay: 0.4 }}
            />
            <motion.path
