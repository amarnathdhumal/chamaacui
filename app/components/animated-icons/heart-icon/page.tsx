...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/heart-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/heart-icon/heart-icon-demo.tsx");
        ...
        <div className="flex flex-col w-full">
            <HeartIconPreviewWrapper
                ...
                props={[
                    ...
                    { name: "duration", type: "number", default: "0.8", description: "Duration of the animation in seconds", required: false },
