...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/cloud-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/cloud-icon/cloud-icon-demo.tsx");
