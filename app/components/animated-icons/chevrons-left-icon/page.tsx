...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/chevrons-left-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/chevrons-left-icon/chevrons-left-icon-demo.tsx");
