...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/eye-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/eye-icon/eye-icon-demo.tsx");
        ...
        <div className="flex flex-col w-full">
            <EyeIconPreviewWrapper
                ...
                props={[
                    ...
                    { name: "duration", type: "number", default: "3", description: "Duration of the animation in seconds", required: false },
