...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/volume-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/volume-icon/volume-icon-demo.tsx");
