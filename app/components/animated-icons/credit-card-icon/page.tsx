...
const filePath = path.join(
  process.cwd(),
  "registry/chamaac/animated-icons/credit-card-icon.tsx"
);
const demoFilePath = path.join(
  process.cwd(),
  "app/components/animated-icons/credit-card-icon/credit-card-icon-demo.tsx"
);
  ...
  return (
    <div className="flex flex-col w-full">
      <CreditCardIconPreviewWrapper
        ...
        description="An animated credit card icon."
        code={DemoSource}
        codeFilename="credit-card-icon-demo.tsx"
