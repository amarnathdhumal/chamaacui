...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/send-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/send-icon/send-icon-demo.tsx");
