...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/rocket-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/rocket-icon/rocket-icon-demo.tsx");
