import LoadingIconPreviewWrapper from "./loading-icon-preview-wrapper";
import fs from "fs";
...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/loading-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/loading-icon/loading-icon-demo.tsx");
const ComponentSource = fs.readFileSync(filePath, "utf-8");
const DemoSource = fs.readFileSync(demoFilePath, "utf-8");

export const metadata = constructMetadata({
    title: "Loading Icon",
    description: "An animated loading icon with spinning animation.",
    image: "/components/animated-icons.png",
});

export default function LoadingIconPage() {
    return (
        <div className="flex flex-col w-full">
            <LoadingIconPreviewWrapper
                title="Loading Icon"
                description="An animated loading icon with spinning animation."
                code={
