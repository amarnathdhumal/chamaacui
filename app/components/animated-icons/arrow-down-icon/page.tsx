...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/arrow-down-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/arrow-down-icon/arrow-down-icon-demo.tsx");
