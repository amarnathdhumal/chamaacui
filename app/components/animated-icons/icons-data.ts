...
export const icons: IconTypes[] = [
  ...
  },
  {
    ...
    slug: "menu-icon",
    component: MenuIcon,
    href: "/components/animated-icons/menu-icon",
  },
  {
    name: "Alert",
    slug: "alert-circle-icon",
    component: AlertCircleIcon,
    href: "/components/animated-icons/alert-circle-icon",
  },
  {
    name: "External Link",
    slug: "external-link-icon",
    component: ExternalLinkIcon,
    href: "/components/animated-icons/external-link-icon",
  },
  {
    name: "Cloud",
    slug: "cloud-icon",
    component: CloudIcon,
    href: "/components/animated-icons/cloud-icon",
  },
  {
    name: "Credit Card",
    slug: "credit-card-icon",
    component: CreditCardIcon,
    href: "/components/animated-icons/credit-card-icon",
  },
  {
    name: "Cart",
    slug: "cart-icon",
    component: CartIcon,
    href: "/components/animated-icons/cart-icon",
  },
  {
    name: "Wavy",
    slug: "wavy-icon",
  ...
  },
  {
    ...
    href: "/components/animated-icons/arrow-left-icon",
  },
  {
    name: "Arrow Up",
    slug: "arrow-up-icon",
    component: ArrowUpIcon,
    href: "/components/animated-icons/arrow-up-icon",
  },
  {
    name: "Arrow Down",
    slug: "arrow-down-icon",
    component: ArrowDownIcon,
    href: "/components/animated-icons/arrow-down-icon",
  },
  {
    name: "Arrow Up Right",
    slug: "arrow-up-right-icon",
    component: ArrowUpRightIcon,
    href: "/components/animated-icons/arrow-up-right-icon",
  },
  {
    name: "Arrow Up Left",
    slug: "arrow-up-left-icon",
    component: ArrowUpLeftIcon,
    href: "/components/animated-icons/arrow-up-left-icon",
  },
  {
    name: "Arrow Down Left",
    slug: "arrow-down-left-icon",
    component: ArrowDownLeftIcon,
    href: "/components/animated-icons/arrow-down-left-icon",
  },
  {
    name: "Arrow Down Right",
    slug: "arrow-down-right-icon",
    component: ArrowDownRightIcon,
    href: "/components/animated-icons/arrow-down-right-icon",
  },
  {
    name: "Chevron Right",
    slug: "chevron-right-icon",
    component: ChevronRightIcon,
    href: "/components/animated-icons/chevron-right-icon",
  },
  {
    name: "Chevron Left",
    slug: "chevron-left-icon",
    component: ChevronLeftIcon,
    href: "/components/animated-icons/chevron-left-icon",
  },
  {
    name: "Chevron Up",
    slug: "chevron-up-icon",
    component: ChevronUpIcon,
    href: "/components/animated-icons/chevron-up-icon",
  },
  {
    name: "Chevron Down",
    slug: "chevron-down-icon",
    component: ChevronDownIcon,
    href: "/components/animated-icons/chevron-down-icon",
  },
  {
    name: "Chevrons Right",
    slug: "chevrons-right-icon",
    component: ChevronsRightIcon,
    href: "/components/animated-icons/chevrons-right-icon",
  },
  {
    name: "Chevrons Left",
    slug: "chevrons-left-icon",
    component: ChevronsLeftIcon,
    href: "/components/animated-icons/chevrons-left-icon",
  },
  {
    name: "Chevrons Up",
    slug: "chevrons-up-icon",
    component: ChevronsUpIcon,
    href: "/components/animated-icons/chevrons-up-icon",
  },
  {
    name: "Chevrons Down",
    slug: "chevrons-down-icon",
    component: ChevronsDownIcon,
    href: "/components/animated-icons/chevrons-down-icon",
  },
  {
    name: "Download",
    slug: "download-icon",
  ...
  },
  {
    ...
    href: "/components/animated-icons/rocket-icon",
  },
  {
    name: "Zap",
    slug: "zap-icon",
    component: ZapIcon,
    href: "/components/animated-icons/zap-icon",
  },
  {
    name: "Eye",
    slug: "eye-icon",
    component: EyeIcon,
    href: "/components/animated-icons/eye-icon",
  },
  {
    name: "Send",
    slug: "send-icon",
    component: SendIcon,
    href: "/components/animated-icons/send-icon",
  },
  {
    name: "Volume",
    slug: "volume-icon",
    component: VolumeIcon,
    href: "/components/animated-icons/volume-icon",
  },
  {
    name: "Check",
    slug: "check-icon",
    component: CheckIcon,
    href: "/components/animated-icons/check-icon",
  },
  {
    name: "Sparkle",
    slug: "sparkle-icon",
    component: SparkleIcon,
    href: "/components/animated-icons/sparkle-icon",
  },
  {
    name: "Calendar",
    slug: "calendar-icon",
    component: CalendarIcon,
    href: "/components/animated-icons/calendar-icon",
  },
  {
    name: "Shield",
    slug: "shield-icon",
    component: ShieldIcon,
    href: "/components/animated-icons/shield-icon",
  },
  {
    name: "Upload",
    slug: "upload-icon",
    component: UploadIcon,
    href: "/components/animated-icons/upload-icon",
  },
  {
    name: "Message",
    slug: "message-icon",
    component: MessageIcon,
    href: "/components/animated-icons/message-icon",
  },
  {
    name: "Search",
    slug: "search-icon",
    component: SearchIcon,
    href: "/components/animated-icons/search-icon",
  },
  {
    name: "Close",
    slug: "close-icon",
    component: CloseIcon,
    href: "/components/animated-icons/close-icon",
  },
  {
    name: "Clock",
    slug: "clock-icon",
    component: ClockIcon,
    href: "/components/animated-icons/clock-icon",
  },
  {
    name: "Layers",
    slug: "layers-icon",
    component: LayersIcon,
    href: "/components/animated-icons/layers-icon",
  },
  {
    name: "Moon",
    slug: "moon-icon",
    component: MoonIcon,
    href: "/components/animated-icons/moon-icon",
  },
  {
    name: "Sun",
    slug: "sun-icon",
    component: SunIcon,
    href: "/components/animated-icons/sun-icon",
  },
  {
    name: "Trash",
    slug: "trash-icon",
    component: TrashIcon,
    href: "/components/animated-icons/trash-icon",
  },
  {
    name: "Battery",
    slug: "battery-icon",
    component: BatteryIcon,
    href: "/components/animated-icons/battery-icon",
  },
  {
    name: "Gift",
    slug: "gift-icon",
    component: GiftIcon,
    href: "/components/animated-icons/gift-icon",
  },
  {
    name: "Crown",
    slug: "crown-icon",
    component: CrownIcon,
    href: "/components/animated-icons/crown-icon",
  },

  {
    ...
    href: "/components/animated-icons/thumbs-up-icon",
  },
];
