...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/music-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/music-icon/music-icon-demo.tsx");
