...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/check-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/check-icon/check-icon-demo.tsx");
        ...
        <div className="flex flex-col w-full">
            <CheckIconPreviewWrapper
                ...
                props={[
                    ...
                    { name: "duration", type: "number", default: "2.5", description: "Duration of the animation in seconds", required: false },
