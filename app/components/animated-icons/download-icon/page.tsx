...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/download-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/download-icon/download-icon-demo.tsx");
