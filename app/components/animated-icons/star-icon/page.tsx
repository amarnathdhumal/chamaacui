...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/star-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/star-icon/star-icon-demo.tsx");
