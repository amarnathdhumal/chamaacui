...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/alert-circle-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/alert-circle-icon/alert-circle-icon-demo.tsx");
