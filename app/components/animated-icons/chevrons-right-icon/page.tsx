...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/chevrons-right-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/chevrons-right-icon/chevrons-right-icon-demo.tsx");
