...
const filePath = path.join(process.cwd(), "registry/chamaac/animated-icons/arrow-up-icon.tsx");
const demoFilePath = path.join(process.cwd(), "app/components/animated-icons/arrow-up-icon/arrow-up-icon-demo.tsx");
