    ...
    return (
        <div className="w-full h-screen flex justify-center items-center bg-white">
            <div className="flex flex-row items-center justify-center">
                <svg width="471" height="171" viewBox="0 0 471 171" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path d="M163 67.7762L198.961 27.1921C206.153 20 206.153 20 221.051 20H247.251" stroke="url(#paint1_upper)" />
                    <motion.path d="M163 103L198.961 143.584C206.153 150.776 206.153 150.776 221.051 150.776H247.251" stroke="url(#paint2_upper)" />
                    <motion.line x1="165" y1="84.5" x2="288.293" y2="84.5" stroke="url(#paint3_upper)" />
                    <rect x="0.5" y="65.5" width="164" height="39" rx="4.5" fill="white" stroke="#E8E8E8" />
                    <motion.path
                    ...
                    <rect x="247.5" y="131.5" width="141" height="39" rx="4.5" stroke="#E8E8E8" />
                    <text
                        x="318"
                        y="151"
                        textAnchor="middle"
                    ...
                    <rect x="288.5" y="63.5" width="182" height="39" rx="4.5" stroke="#E8E8E8" />
                    <text
                        x="379.5"
                        y="83"
                        textAnchor="middle"
                    ...
                    <rect x="247.5" y="0.5" width="153" height="39" rx="4.5" stroke="#E8E8E8" />
                    <text
                        x="324"
                        y="20"
                        textAnchor="middle"
