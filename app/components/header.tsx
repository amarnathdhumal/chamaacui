...
import { IconBrightness, IconBrandX, IconSearch, IconBrandGithub, IconMenu2, IconX } from "@tabler/icons-react";
      ...
      >
        <div className="flex justify-between items-center max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12 py-4">
          <div className="flex items-center gap-4 md:gap-15 flex-row relative z-10">
            <Link href="/" className="flex flex-row items-center gap-[8px] focus:outline-none focus-visible:outline-none">
          ...
          <div className="hidden sm:flex items-center gap-2 md:gap-4 flex-row relative z-10">
            ...
            >
              <IconSearch size={16} />
              <span className="hidden lg:inline-block text-sm/5 ">Search Components</span>
            ...
            >
              ...
              <div className="flex items-center justify-between w-full">
                ...
                >
                  ...
                  <p className="font-bold text-[20px] leading-none tracking-tight text-black dark:text-white">Chamaac UI</p>
                </Link>
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
                ...
                <ul>
                  ...
                  <li className="border-b border-gray-200 dark:border-neutral-800 -mx-4">
                    ...
                    >
                      ...
                      <IconBrightness size={24} className="text-neutral-500 dark:text-gray-400" />
                    </button>
                  </li>
                </ul>
              </div>
