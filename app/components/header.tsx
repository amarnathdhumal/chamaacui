...
export const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-50 w-full flex justify-between items-center max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12 backdrop-blur-sm transition-all duration-300 ${isScrolledBeyondViewport
