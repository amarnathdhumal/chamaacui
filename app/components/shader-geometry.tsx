...
//     const materialRef = useRef<THREE.ShaderMaterial & { u_time: number; u_frame: number; u_resolution: THREE.Vector2; u_mouse: THREE.Vector2 }>(null)
//     // const { size } = useThree()
...
//     return (
//         <mesh ref={meshRef}>
//             {geometryType === 'Torus knot' && <torusKnotGeometry args={[6.5, 2.3, 256, 32]} />}
...
//     const [geometry, setGeometry] = useState<'Torus knot' | 'Sphere' | 'Icosahedron'>('Torus knot')
...
//                 <label className="text-xs uppercase tracking-widest opacity-50">Geometry</label>
//                 <select
//                     value={geometry}
