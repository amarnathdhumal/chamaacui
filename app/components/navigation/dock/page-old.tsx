...
const Dock = () => {
    ...
    return (
        ...
        <div className="bg-white dark:bg-white min-h-screen w-full" style={{ backgroundColor: 'white' }}>
                    ...
                    >
                            ...
                            <div className="bg-white px-[15px] pt-[15px]  pb-[30px] flex justify-between items-start">
                                <div className=" gap-[12.5px] flex flex-col">
                                    <motion.a
                                        ...
                                        href="/jeton-card"
                                        className={`block text-[14px] leading-[10px] transition-colors font-medium ${hoveredLink === "/jeton-card" ? "text-black" : "text-[#C1C1C1] hover:text-black"
                                            }`}
                                    >
                                        Jeton Card
                                    </motion.a>
                                    ...
                                    <motion.a
                                        ...
                                        href="/fees"
                                        className={`block text-[14px] leading-[10px] transition-colors ${hoveredLink === "/fees" ? "text-black" : "text-[#C1C1C1] hover:text-black"
                                            }`}
                                    >
                                        Fees
                                    </motion.a>
                            ...
                            <div className="bg-white px-[15px] pt-[15px] pb-[30px] flex justify-between items-start">
                                <div className=" gap-[12.5px] flex flex-col">
                                    <motion.a
                                        ...
                                        href="/about"
                                        className={`block text-[14px] leading-[10px] transition-colors font-medium ${hoveredLink === "/about" ? "text-black" : "text-[#C1C1C1] hover:text-black"
                                            }`}
                                    >
                                        About
                                    </motion.a>
                                    ...
                                    <motion.a
                                        ...
                                        href="/newsroom"
                                        className={`block text-[14px] leading-[10px] transition-colors ${hoveredLink === "/newsroom" ? "text-black" : "text-[#C1C1C1] hover:text-black"
                                            }`}
                                    >
                                        Newsroom
                                    </motion.a>
                                    ...
                                    <motion.a
                                        ...
                                        href="/partnerships"
                                        className={`block text-[14px] leading-[10px] transition-colors ${hoveredLink === "/partnerships" ? "text-black" : "text-[#C1C1C1] hover:text-black"
                                            }`}
                                    >
                                        Partnerships
                                    </motion.a>
                                    ...
                                    <motion.a
                                        ...
                                        href="/media-assets"
                                        className={`block text-[14px] leading-[10px] transition-colors ${hoveredLink === "/media-assets" ? "text-black" : "text-[#C1C1C1] hover:text-black"
                                            }`}
                                    >
                                        Media Assets
                                    </motion.a>
                                    ...
                                    <motion.a
                                        ...
                                        href="/release-notes"
                                        className={`block text-[14px] leading-[10px] transition-colors ${hoveredLink === "/release-notes" ? "text-black" : "text-[#C1C1C1] hover:text-black"
                                            }`}
                                    >
                                        Release Notes
                                    </motion.a>
                        ...
                        <div className="flex items-center gap-[3px] relative z-10">
                            ...
                            <motion.div
                                ...
                                onMouseLeave={handleMouseLeave}
                                animate={{
                                    backgroundColor: isPersonalOpen || (pathname === "/finvastra-advisors" || pathname === "/finvastra-wealth" || pathname === "/finvastra-insurance-marketing") ? "#F0F0F0" : "transparent"
                                }}
                            ...
                            <Link
                                href="/company"
                                className={`text-black transition-colors duration-200 text-[14px] leading-[10px] flex items-center gap-1  h-[42px] rounded-full hover:bg-[#F0F0F0] px-[18px] ${pathname === "/company" ? "bg-[#F0F0F0]" : ""
                                    }`}
                            ...
                            <motion.div
                                ...
                                onMouseLeave={handleCompanyMouseLeave}
                                animate={{
                                    backgroundColor: isCompanyOpen || (pathname === "/about" || pathname === "/newsroom" || pathname === "/partnerships" || pathname === "/media-assets" || pathname === "/release-notes") ? "#F0F0F0" : "transparent"
                                }}
                                whileHover={{ backgroundColor: "#F0F0F0" }}
                                transition={{ duration: 0.2 }}
                            >
