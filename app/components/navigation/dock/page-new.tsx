      ...
      <DockPreviewWrapper
        ...
        props={[
          ...
          },
          {
            ...
            default: "-",
            description:
              "Menu group configuration for personal menu items. Each MenuGroup has a label and items array. Each MenuItem has label, href, and optional image.",
            required: false,
          },
          {
            name: "companyMenu",
            ...
            default: "-",
            description:
              "Menu group configuration for company menu items. Each MenuGroup has a label and items array. Each MenuItem has label, href, and optional image.",
            required: false,
          },
          {
            name: "businessHref",
          ...
          },
          {
            ...
            default: "{}",
            description:
              "Object mapping menu item hrefs to image paths. Used to display preview images when hovering over menu items.",
            required: false,
          },
          {
            name: "closeDelay",
