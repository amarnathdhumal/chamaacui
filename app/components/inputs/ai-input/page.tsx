  ...
  return (
    <div className="flex flex-col w-full">
      <AIInputPreviewWrapper
        ...
        description={
          <>
            A polished AI input component with model selection, tools dropdown,
            file uploads, and smooth animations. Inspired from Google Gemini.
          </>
        }
        code={AIInputDemoSource}
        codeFilename="ai-input-demo.tsx"
        ...
        props={[
          {
            ...
            description:
              "Array of AI models to display in the model selector dropdown. Each model has id, name, label, and icon.",
            required: false,
          },
          {
            name: "tools",
            ...
            description:
              "Array of tools to display in the tools dropdown. Each tool has an icon and label.",
            required: false,
          },
          {
            name: "plusMenuItems",
            ...
            description:
              "Array of items for the plus button menu. Each item has id, icon, and label.",
            required: false,
          },
          {
            name: "onSubmit",
            ...
            default: "-",
            description:
              "Callback function called when user submits a message. Receives the message text and array of attachments.",
            required: false,
          },
          {
            name: "placeholder",
          ...
          },
          {
            ...
            props: [
              ...
              },
              {
                ...
                default: "false",
                description:
                  "Whether chevron should be rotated (for open state)",
                required: false,
              },
              {
                name: "showClose",
