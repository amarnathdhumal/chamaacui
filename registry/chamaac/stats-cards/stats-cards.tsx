...
export function StatsCards({
    ...
    return (
        <div className={cn("flex flex-wrap items-center justify-center gap-6 sm:gap-4 md:gap-0 px-4 py-4 bg-orange-50", inter.className, className)}>
            {/* Card 1: Revenue */}
            <motion.div
                className={cn(`relative z-10 ${width} ${height} bg-white rounded-[16px] p-5 flex flex-col justify-between hover:z-50`)}
                initial={{
                    rotate: -3
                }}
            ...
            >
                <div>
                    <h2 className="text-[#FF4400] text-5xl font-semibold tracking-tighter">$100k+</h2>
                </div>
                <div>
                    <h4 className="text-[#FF4400] font-medium text-lg leading-tight tracking-tighter">Revenue driven</h4>
            ...
            {/* Card 2: Image Stats */}
            <motion.div
                className={cn(`relative z-20 ${width} ${height} rounded-[16px] overflow-hidden group hover:z-50`)}
                initial={{
                    rotate: 2,
                    y: 1
                }}
            ...
            {/* Card 3: Impressions */}
            <motion.div
                className={cn(`relative z-30 ${width} ${height} bg-[#FF4400] rounded-[16px] p-5 flex flex-col justify-between  flex-shrink-0 hover:z-50`)}
                initial={{
                    rotate: 8,

                }}
                whileHover={{ rotate: 0, scale: 1.02, transition: { duration: 0.3, ease: "easeInOut" } }}
            >
                <div>
                    <h2 className="text-white text-5xl font-semibold tracking-tighter">37M+</h2>
                </div>
                <div>
                    <h4 className="text-white font-medium text-lg leading-tight tracking-tighter">Organic impressions</h4>
            ...
            {/* Card 4: Image Stats */}
            <motion.div
                className={cn(`relative z-40 ${width} ${height} rounded-[16px] overflow-hidden -ml-1 hover:z-50`)}
                initial={{
                    rotate: -4
                }}
                whileHover={{ rotate: 0, scale: 1.05, transition: { duration: 0.3, ease: "easeInOut" } }}
