...
const ShimmerButton = ({
    ...
    return (
        <button onClick={onClick} className={cn("group relative  bg-neutral-950 px-8 py-3 rounded-full cursor-pointer transition-all hover:scale-[1.02] active:scale-[0.98]", className)}>
