        ...
        <section className="pb-[70px] bg-black">
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-[70px] h-screen flex items-center justify-center">
                ...
                <div className="flex flex-row justify-between items-center">
                    ...
                    <motion.svg width="309" height="422" viewBox="0 0 309 422" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <motion.path d="M0 84.5C155 84.5 155 208.5 308.5 208.5" stroke="url(#paint0)" />
                        <motion.path d="M0.5 0.5C154.5 0.5 155.5 206.5 308.5 206.5" stroke="url(#paint1)" />
                        <motion.path d="M0.5 168.5C155 168.5 155 210.5 308.5 210.5" stroke="url(#paint2)" />
                        <motion.path d="M0 337C155 337 155 213 308.5 213" stroke="url(#paint4)" />
                        <motion.path d="M0.5 421C154.5 421 155.5 215 308.5 215" stroke="url(#paint3)" />
                        <motion.path d="M0.5 253C155 253 155 211 308.5 211" stroke="url(#paint5)" />
                        <defs>
                            {/* 1st Gradient */}
