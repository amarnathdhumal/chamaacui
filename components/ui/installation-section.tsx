...
import PackageManagerSelector, { PackageManager } from "@/components/ui/package-manager-selector";
...
export default function InstallationSection({
    ...
    const getCliCommand = (pm: PackageManager, name: string) => {
        ...
        switch (pm) {
            ...
            case "bun": return `bunx shadcn@latest add ${url}`;
            case "pnpm": return `pnpm dlx shadcn@latest add ${url}`;
            case "yarn": return `npx shadcn@latest add ${url}`;
        }
    };
