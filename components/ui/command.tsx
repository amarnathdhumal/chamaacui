      ...
      >
        ...
        <div className="flex items-center justify-between border-t border-border px-4 py-2 text-xs  bg-white dark:bg-black">
          ...
          <div className="flex gap-2 items-center ">
            <span className="text-sm/5 text-neutral-600 dark:text-gray-300">
              Exit
            </span>
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        "max-h-80 scroll-py-0 overflow-x-hidden overflow-y-auto min-h-80 supports-timeline-scroll:scroll-fade-effect-y",
        className
      )}
      {...props}
    />
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "dark:data-[selected=true]:bg-neutral-800 data-[selected=true]:bg-neutral-200  [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center  rounded-[8px] px-2 py-[6px] text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 transition-colors",
        className
      )}
      {...props}
    />
